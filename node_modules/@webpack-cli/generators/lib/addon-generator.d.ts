 ...
 */
declare const addonGenerator: (prompts: Generator.Questions, templateDir: string, templateFn: (instance: any) => Record<string, unknown>) => Generator.GeneratorConstructor;
