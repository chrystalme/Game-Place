 ...
 */
const addonGenerator = (prompts, templateDir, 
    ...
    return class extends yeoman_generator_1.default {
        ...
        async prompting() {
            if (!this.supportedTemplates.includes(this.template)) {
                ...
                const { selectedTemplate } = await scaffold_utils_1.List(this, 'selectedTemplate', 'Select a valid template from below:', this.supportedTemplates, 'default', false);
        ...
        writing() {
            ...
            copyFiles.forEach((filePath) => {
                ...
                const destFilePath = path_1.default.relative(this.resolvedTemplatePath, filePath).replace('.tpl', '');
            ...
            copyTemplateFiles.forEach((filePath) => {
                ...
                const destFilePath = path_1.default.relative(this.resolvedTemplatePath, filePath).replace('_', '').replace('.tpl', '');
