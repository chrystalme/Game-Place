...
async function questions(self, Question) {
    ...
    self.answers = Object.assign(Object.assign({}, self.answers), { langType, devServer, htmlWebpackPlugin });
    ...
    self.answers = Object.assign(Object.assign({}, self.answers), { cssType, isCSS, isPostCSS, extractPlugin });
}
